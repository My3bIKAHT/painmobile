...
def index(request):
    ...
    return render(request, 'stomachpain/index.html', context)
...
def edit(request, question_id):
	...
	return render(request, 'stomachpain/question.html', {'form': form, 'message': message, 'dictionary': dictionary,})
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			if form.cleaned_data['question_id'] == "-1":
				...
				#return render(request, 'stomachpain/question.html', {'form': form, 'dictionary': dictionary,})
				return redirect('/stomachpain/')
			else:
				#case: редактируем
...
def drug_add(request):
	...
	return render(request, 'stomachpain/drug.html', {'form': form, 'message': message, 'dictionary': dictionary,})
...
def drug_edit(request, drug_id):
	...
	return render(request, 'stomachpain/drug.html', {'form': form, 'message': message, 'drug_id': drug_id, 'image_url': image_url, 'dictionary': dictionary, })
